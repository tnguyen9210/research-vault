...
- [[offline-reinforcement-learning]] — shares the smooth-aggregator-instead-of-max design pattern ([[power-mean-mcts]] and [[expectile-regression]] are two instances), and the same underlying problem of maximizing over noisy value estimates
- [[smooth-aggregators]] — the cross-cutting pattern itself: three parameterized interpolations averaging→max, and the open unified analysis
