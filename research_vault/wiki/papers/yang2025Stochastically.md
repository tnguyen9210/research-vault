...
citekey: yang2025Stochastically
---
...
This is the **fixed-budget** analogue of [[bai-constrained]] (which is fixed-confidence). The paper calls it BFAI; the same problem structure appears in the simulation optimization literature as constrained ranking-and-selection (R&S).
