...
- [[mcts]] — the algorithmic framework this paper operates within
- [[mcts-power-mean]] — the novel algorithm introduced here
- Emilie Kaufmann — third author; also known for TAS (BAI), connecting to [[bai]]
