...
<!-- Math here avoids GitHub's markdown hazards so it renders in Obsidian and on GitHub alike: \ast for *, \lbrace and \rbrace for braces, no \, \; \! spacing, a blank line on both sides of every display block. Check with scripts/check_math.py. -->
