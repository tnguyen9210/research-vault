...
## Key Papers
- [[SimchiLevi2022Bypassing]] — realizability enables FALCON to achieve optimal regret with $O(\log T)$ offline oracle calls; the implicit policy distribution argument relies on $q^* \in \mathcal{F}$
