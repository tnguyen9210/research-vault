...
- [[monte-carlo-tree-search-power-mean]] / [[Dam2024Power]] — analogous idea in tree search: replacing max backup with a power-mean backup improves convergence; both papers argue greedy aggregation is suboptimal under estimation noise
