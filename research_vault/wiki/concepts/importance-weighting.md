...
- [[fitted-q-iteration-pessimistic]] — the sequential-RL counterpart: the same pessimism principle, but the uncertainty is an elliptical/gradient-geometry penalty on the fitted Q-function rather than a concentration bound on IW estimates
