...
- [[yin2023Offline]] — adopts DFA for policy *learning*; first non-asymptotic, instance-dependent offline RL bound over a nonlinear class, via [[fqi-pessimistic]]
...
- [[fqi-pessimistic]] — the algorithm analyzed over this class
